...
/**
 * Performs the complete initialization of the Sentience SDK instance.
 *
 ...
 *
 * @param instance The SentienceSDK instance to be fully initialized.
 * @returns void
 * @async
 */
export declare function performSDKInitialization(instance: SentienceSDK): Promise<void>;
