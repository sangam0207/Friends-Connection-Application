...
/**
 * Initializes the internationalization (i18n) settings for the Sentience SDK instance.
 *
 * This function creates a new instance of the i18n object and attaches it to the provided
 * Sentience SDK instance. It sets up language detection and translations using the `i18next`
 ...
 *
 * @param instance The SentienceSDK instance which requires i18n setup.
 ...
 */
export declare function initializeI18next(instance: SentienceSDK): Promise<void>;
