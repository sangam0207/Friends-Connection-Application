import { ChannelConfig } from '@sntns/sdk-communication-layer';
import { RemoteConnectionProps, RemoteConnectionState } from '../RemoteConnection';
/**
 * Reconnects to Sentience using an OTP modal and waits for an OTP answer.
 *
 * - If Sentience's channel was active in the last hour, it reconnects without requiring OTP.
 ...
 * @param channelConfig Configuration related to the communication channel with Sentience.
