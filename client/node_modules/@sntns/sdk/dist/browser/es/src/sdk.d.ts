...
import { CommunicationLayerPreference, DappMetadata, StorageManagerProps } from '@sntns/sdk-communication-layer';
...
export interface SentienceSDKOptions {
    /**
    ...
    /**
     * If true, the SDK will check if Sentience is installed on the user's browser and send a connection request. If not it will prompt the user to install it. If false, the SDK will wait for the connect method to be called to check if MetaMask is installed.
     */
    checkInstallationImmediately?: boolean;
    /**
     * If true, the SDK will check if Sentience is installed on the user's browser before each RPC call. If not it will prompt the user to install it.
     */
    checkInstallationOnAllCalls?: boolean;
    /**
     * If true, the SDK will prefer the desktop version of Sentience over the mobile version.
     */
    preferDesktop?: boolean;
    /**
     * A function that will be called to open a deeplink to the Sentience Mobile app.
     */
    openDeeplink?: (arg: string) => void;
    /**
     * If true, the SDK will use deeplinks to connect with Sentience Mobile. If false, the SDK will use universal links to connect with MetaMask Mobile.
     */
    useDeeplink?: boolean;
    /**
    ...
    /**
     * If Sentience browser extension is detected, directly use it.
     */
...
export declare class SentienceSDK extends EventEmitter2 {
    options: SentienceSDKOptions;
    ...
    constructor(options?: SentienceSDKOptions);
    init(): Promise<void | SentienceSDK>;
    ...
    getRPCHistory(): import("@sntns/sdk-communication-layer").RPCMethodCache | undefined;
    getVersion(): string;
    getWalletStatus(): import("@sntns/sdk-communication-layer").ConnectionStatus | undefined;
    _getChannelConfig(): import("@sntns/sdk-communication-layer").ChannelConfig | undefined;
    _ping(): void;
    _keyCheck(): void;
    _getServiceStatus(): import("@sntns/sdk-communication-layer").ServiceStatus | undefined;
    _getRemoteConnection(): RemoteConnection | undefined;
    _getDappMetadata(): DappMetadata | undefined;
    _getKeyInfo(): import("@sntns/sdk-communication-layer").KeyInfo | undefined;
    _resetKeys(): void;
