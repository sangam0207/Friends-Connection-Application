...
/**
 * Connects the SentienceSDK instance to the MetaMask browser extension as the active provider.
 *
 ...
 *
 * @param instance The current instance of the SentienceSDK, which contains user-defined or default options.
 * @returns {Promise<void>} A Promise that resolves when the connection has been established or an error has been caught.
 */
export declare function connectWithExtensionProvider(instance: SentienceSDK): Promise<void>;
